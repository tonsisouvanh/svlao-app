  ...
  return (
    <>
      <section className="relative">
        {documents[0] && documents.length > 0 && status.fetchAll !== 'loading' ? (
          <div className="container mx-auto px-5 py-24">
            <div className="mb-12 flex w-full flex-col text-center">
              <h1 className="title-font m:text-3xl mb-4 mt-10 text-2xl font-medium">Edit document</h1>
              <div>
            ...
            <div className="mx-auto">
              <form onSubmit={handleSubmit(handleEditSubmit)} className="flex flex-col items-center justify-center">
                ...
                <div className="w-full p-2">
                  <label className="form-control w-full">
                    <div className="label flex items-center">
                      ...
                      <ErrorMessage styling="sm:text-md" error={errors?.fileUrl} />
                    </div>
                    <input
                      {...register('fileUrl', {
                        required: 'Field required',
                ...
                <div className="w-full p-2">
                  <label className="form-control w-full">
                    <div className="label flex items-center">
                      <span className="label-text font-semibold">Download Count</span>
                      <ErrorMessage styling="sm:text-md" error={errors?.downloadsCount} />
                    </div>
                    <input {...register('downloadsCount', {})} className={`input input-bordered w-full max-w-full`} />
                  </label>
                </div>
                <div className="w-full p-2">
                  <label className="form-control w-full">
                    <div className="label flex items-center">
                      ...
                      <ErrorMessage styling="sm:text-md" error={errors?.description} />
                    </div>
                    <textarea
