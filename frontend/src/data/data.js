...
export const provinceList = [
  ...
  },
  {
    ...
    englishName: 'Luang Namtha',
    laoName: 'ຫຼວງນ້ຳທາ',
  },
  {
    id: 'clTvDuYJHb5rKUVuABWe',
...
export const statusList = [{ status: 'pending' }, { status: 'active' }, { status: 'inactive' }, { status: 'locked' }];
export const residenceAddressList = [
  {
    address: 'KTX khu B đại học quốc gia, Tô Vĩnh Diện, Đông Hoà, Dĩ An, Bình Dương',
  ...
  {
    address: '122ABC Đ. Cách Mạng Tháng 8, Võ Thị Sáu, Quận 3, Thành phố Hồ Chí Minh',
    location: 'KTX SVLAO',
  },
  {
    address: 'other',
