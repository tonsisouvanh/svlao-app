            ...
            <div className="container mx-auto flex flex-col px-5 py-24 ">
              <div className="flex gap-60">
                ...
                <div className="grid grid-cols-2 gap-20">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">ວັນ ເດືອນ ປີ ເກີດ:</h2>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">ທຶນການສຶກສາ:</h2>
                    <p className="font-notosanslao text-2xl">
                      {student.sacolaship}
                      {monutchinh === true ? (
                        <input
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">ເບີໂທຕິດຕໍ່ສຸກເສີນ:</h2>
                    <p className="font-notosanslao text-2xl">
