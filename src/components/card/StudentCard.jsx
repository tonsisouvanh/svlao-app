    ...
    <div className="rounded-lg bg-base-200 shadow-md ">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-around">
          ...
          {/* <a
            href=""
            className="mr-2 rounded-full p-2 text-blue-500 shadow-md hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <a
            href=""
            className="mr-2 rounded-full p-2 text-red-600 shadow-md hover:text-red-700 dark:text-gray-400 dark:hover:text-red-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <a
            href=""
            className="mr-2 rounded-full p-2 text-pink-600 shadow-md hover:text-pink-800 dark:text-gray-400 dark:hover:text-pink-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <div className="mt-4 flex justify-center px-2">
          <div className="flex-grow space-y-2">
            <h2 className="label-text text-xl">{student?.fullname?.laoName}</h2>
            <div className="flex items-center gap-1">
              <p className="label-text">{student?.major?.laoMajor}</p>
              <p className="label-text">({student?.major?.vietMajor})</p>
            </div>

            <div className="flex flex-wrap justify-end gap-2">
              <Link to={`/detail/${student?.id}`} className="">
